...
// newGenerateCmd creates the generate addPkg command
func newGenerateCmd() *ffcli.Command {
	...
	return &ffcli.Command{
		...
		ShortHelp:  "Generates and outputs the default addPkg configuration",
		LongHelp:   "Generates and outputs the default addPkg configuration",
		FlagSet:    fs,
		Exec:       cfg.exec,
	}
}

// registerFlags registers the addPkg root command flags
...
// exec executes the addPkg generate command
