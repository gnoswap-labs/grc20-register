...
type (
	...
	getAbciQueryDelegate         func(string, []byte) (*core_types.ResultABCIQuery, error)
...
type mockClient struct {
	...
	getAbciQueryFn         getAbciQueryDelegate
...
func (m *mockClient) GetAbciQuery(path string, data []byte) (*core_types.ResultABCIQuery, error) {
	if m.getAbciQueryFn != nil {
		return m.getAbciQueryFn(path, data)
	}
